...
const SettingsPage = () => {
  ...
  const addClothType = async () => {
    ...
    setClothMsg(axiosErr.response?.data?.message || 'Failed to add')
  }
  }
  ...
  const changePassword = async () => {
    ...
    try {
      ...
      setPwdError((err as { response?: { data?: { message?: string } } })?.response?.data?.message || 'Failed to update password')
    }
  }
  ...
  const changeUsername = async () => {
    ...
    try {
      ...
      setUsernameError((err as { response?: { data?: { message?: string } } })?.response?.data?.message || 'Failed to update username')
    }
  }
